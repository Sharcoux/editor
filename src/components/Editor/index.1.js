...
//letter = {value : char, style: {}}
function formatStyle(style) {
  const letterStyle = ['color', 'fontSize', 'backgroundColor'].map(attr => style[attr]);
}
...
class Editor extends React.PureComponent {
  constructor() {
    ...
    this.getSelectionSize = this.getSelectionSize.bind(this);
    this.isCaretVisible = this.isCaretVisible.bind(this);
    this.setSelection = this.setSelection.bind(this);
    this.setInputStyle = this.setInputStyle.bind(this);
    this.moveCaret = this.moveCaret.bind(this);
    this.insert = this.insert.bind(this);
    this.getParagraphAt = this.getParagraphAt.bind(this);
    this.getCharLocation = this.getCharLocation.bind(this);
